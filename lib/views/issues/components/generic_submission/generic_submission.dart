part of './components/generic_submission_components.dart';

final _pagesProvider = Provider.autoDispose<List<Widget>>((ref) {
  return const [
    GenericSubmissionStep1(),
    GenericSubmissionStep2(),
    GenericSubmissionStep3(),
  ];
});
...
class GenericSubmission extends ConsumerWidget {
  const GenericSubmission({super.key});
